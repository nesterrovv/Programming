...
public class DatabaseManager {
    ...
    public boolean saveToDatabase(Person person) {
        try {
            String insert = "INSERT INTO persons (id, name, x, y, creation_date, height, eye_color, hair_color, nationality, x_location, y_location, name_location, username) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
