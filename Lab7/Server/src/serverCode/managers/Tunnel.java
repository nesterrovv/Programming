...
public class Tunnel {
     ...
     * @param user             User on target SSH host                          (example: s312621)
     ...
     * @param tunnelLocalPort  The port on your machine                         (example: 4241)
     * @param tunnelRemotePort The port on SSH server                           (example: 4242)
     */
    ...
    /**
     * Establish SSH connection and set port forwarding
    ...
    public int connect() {
        ...
        try {
            ...
            //CONNECT SSH
            System.out.println("SSH connecting to " + host + " : " + port);
            ...
            System.out.println("Exception with connecting using SSH tunnel.");
            e.printStackTrace();
        }
        exit(-1);
        return -1;
