...
public final class CollectionManager {
     ...
     */
    public String save(DatabaseManager databaseManager, String me) {
    ...
    public String load(DatabaseManager databaseManager) {
        try (ResultSet answer = databaseManager.getConnection().createStatement().
            ...
            while (answer.next()) {
                ...
                String creationDate = answer.getString("creation_date");
                long height = answer.getInt("height");
                EyeColor eyeColor = EyeColor.valueOf(answer.getString("eye_color"));
                HairColor hairColor = HairColor.valueOf(answer.getString("hair_color"));
                Country nationality = Country.valueOf(answer.getString("nationality"));
                Location location = new Location(answer.getLong("x_location"),
                        answer.getDouble("y_location"), answer.getString("name_location"));
                String owner = answer.getString("owner");
                //Person person = new Person(id, name, coordinates, creationDate.toString(), height, eyeColor, hairColor, nationality, location, owner);
                //System.out.println(person.toString());
                persons.add(new Person(id, name, coordinates, creationDate.toString(), height, eyeColor,
                        hairColor, nationality, location, owner));
            }
